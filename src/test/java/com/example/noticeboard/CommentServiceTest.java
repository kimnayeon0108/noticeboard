...
public class CommentServiceTest {
    ...
    void addComment() {
        ...
        // then
        assertThat(resCommentDtos.get(2).getBody()).isEqualTo("새로운 댓글");
        assertThat(resCommentDtos.get(2).getChildren().size()).isEqualTo(0);
    }
    ...
    void getComments() {
        ...
        assertThat(comment1.getChildren().size()).isEqualTo(2);

        ResCommentDto childOfComment1 = comment1.getChildren().get(0);
        assertThat(childOfComment1.getBody()).isEqualTo("depth2 댓글1");
        assertThat(childOfComment1.getChildren().size()).isEqualTo(1);

        assertThat(childOfComment1.getChildren().get(0).getBody()).isEqualTo("depth3 댓글1");
    }
    ...
    void editComment() {
        ...
        // then
        assertThat(resCommentDtos.get(0).getBody()).isEqualTo("수정된 댓글 내용");
    }
}
